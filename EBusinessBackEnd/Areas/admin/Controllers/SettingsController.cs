...
namespace EBusinessBackEnd.Areas.admin.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Phone,Email")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Phone,Email")] Setting setting)
        {
            if (id != setting.Id)
            {
                return NotFound();
